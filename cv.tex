...
\textbf{Consulente informatico} & \hfill 2018 - presente \\[3.75pt]
\multicolumn{2}{@{}X@{}}{
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=1pt]
        \item[--] Sviluppato e implementato soluzioni di automazione per numerosi studi legali, ottimizzando significativamente le attività amministrative.
        \item[--] Creato e gestito siti e-commerce per PMI, contribuendo all'aumento delle vendite online e alla presenza digitale.
        \item[--] Progettato e realizzato ConcordatoFacile, una piattaforma cloud-based che ha semplificato la gestione dei contratti di locazione a canone concordato per associazioni di categoria in Campania.
        \item[--] Implementato strumenti personalizzati per la gestione di ETF (Exchange Traded Funds), ottimizzando il processo decisionale per gli investimenti di clienti privati.
        \item[--] Fornito consulenza tecnica a professionisti di vari settori, migliorando l'efficienza operativa attraverso l'integrazione di tecnologie cloud e automazione.
    \end{itemize}
    \end{minipage}
}
\end{tabularx}
...
\multicolumn{2}{@{}X@{}}{ConcordatoFacile è una soluzione software cloud-based che ho progettato per semplificare la gestione dei contratti di locazione a canone concordato. Grazie all'integrazione con Google Workspace e JotForm, ConcordatoFacile automatizza la raccolta e l'elaborazione dei dati, rendendo il processo di generazione dei contratti e dei documenti correlati più rapido ed efficiente. La piattaforma elimina la necessità di inserire manualmente i dati, riducendo gli errori e risparmiando tempo prezioso.
ConcordatoFacile offre funzionalità avanzate, tra cui il calcolo automatico dei canoni di locazione, la gestione delle anagrafiche, l'invio di promemoria e molto altro.}  \\
\end{tabularx}
